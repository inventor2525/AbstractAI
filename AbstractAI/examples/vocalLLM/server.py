...
parser.add_argument('model_name', type=str, choices=['tiny', 'tiny.en', 'small', 'small.en', 'medium', 'medium.en', 'large'], help='Whisper model size to use for transcription.', default='medium.en')
parser.add_argument('llm_name', type=str, help='The LLM name to use.', default='stabilityai/StableBeluga2-7B', nargs='?')
